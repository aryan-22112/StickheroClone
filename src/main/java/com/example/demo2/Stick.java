...
public class Stick {
    ...
    public Stick() {
        ...
        double positionX = com.example.demo2.Engine.STAND_CLIFF_X - Stick.WIDTH;
        double positionY = com.example.demo2.Engine.STAND_CLIFF_Y + 0.2; // Y position of the pillar
