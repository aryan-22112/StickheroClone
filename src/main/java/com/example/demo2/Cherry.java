...
public class Cherry implements Serializable {
    ...
    public Cherry(double positionX) {
        double positionY = com.example.demo2.Engine.STAND_CLIFF_Y + 2 * Stick.WIDTH;
        ...
        com.example.demo2.Effects.move_up_down(this.imageview, 5).play();
    }
    ...
    public Cherry generate_random_cherry(double pillars_gap) {
        ...
        positionX = Math.random() * (pillars_gap - Cherry.DIMESION) + com.example.demo2.Engine.STAND_CLIFF_X;
        return new Cherry(positionX);
    }
